...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'fastcloudinit.core': { 'fastcloudinit.core._cc_schema': ('core.html#_cc_schema', 'fastcloudinit/core.py'),
                                    'fastcloudinit.core.apt': ('core.html#apt', 'fastcloudinit/core.py'),
