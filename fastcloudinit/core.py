"""Docs: https://AnswerDotAI.github.io/fastcloudinit/core.html.md"""
...
# %% ../nbs/00_core.ipynb #5d65c3a3
def mounts(devices):
    if not devices: return {}
    return dict(mounts=devices)

# %% ../nbs/00_core.ipynb #9905d396
def runcmd(cmds):
    if not cmds: return {}
